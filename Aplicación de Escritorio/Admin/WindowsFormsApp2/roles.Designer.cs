...
namespace WindowsFormsApp2 {
    ...
    public partial class roles : global::System.Data.DataSet {
        ...
        public partial class ROLESDataTable : global::System.Data.TypedTableBase<ROLESRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ROLESRow AddROLESRow(decimal ID_ROLES, string NOMBREROL) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ROLESRow FindByID_ROLES(decimal ID_ROLES) {
        ...
        public partial class ROLESRow : global::System.Data.DataRow {
            ...
            public decimal ID_ROLES {
                get {
                    return ((decimal)(this[this.tableROLES.ID_ROLESColumn]));
                }
                set {
...
namespace WindowsFormsApp2.rolesTableAdapters {
    ...
    public partial class ROLESTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM \"C##ADMIN_RESTAURANTXXI\".\"ROLES\" WHERE ((\"ID_ROLES\" = :Original_ID_RO" +
                "LES) AND ((:IsNull_NOMBREROL = 1 AND \"NOMBREROL\" IS NULL) OR (\"NOMBREROL\" = :Ori" +
                "ginal_NOMBREROL)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"C##ADMIN_RESTAURANTXXI\".\"ROLES\" (\"ID_ROLES\", \"NOMBREROL\") VALUES (:I" +
                "D_ROLES, :NOMBREROL)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE \"C##ADMIN_RESTAURANTXXI\".\"ROLES\" SET \"ID_ROLES\" = :ID_ROLES, \"NOMBREROL\" =" +
                " :NOMBREROL WHERE ((\"ID_ROLES\" = :Original_ID_ROLES) AND ((:IsNull_NOMBREROL = 1" +
                " AND \"NOMBREROL\" IS NULL) OR (\"NOMBREROL\" = :Original_NOMBREROL)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_ROLES, NOMBREROL FROM \"C##ADMIN_RESTAURANTXXI\".ROLES";
        ...
        public virtual int Delete(string Parameter1, string Parameter2, string Parameter3) {
            if ((Parameter1 == null)) {
        ...
        public virtual int Insert(string Parameter1, string Parameter2) {
            if ((Parameter1 == null)) {
                throw new global::System.ArgumentNullException("Parameter1");
            }
            else {
        ...
        public virtual int Update(string Parameter1, string Parameter2, string Parameter3, string Parameter4, string Parameter5) {
            if ((Parameter1 == null)) {
                throw new global::System.ArgumentNullException("Parameter1");
            }
            else {
